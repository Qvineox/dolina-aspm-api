...
export const protobufPackage = "dolina.cyclonedx.v17";
...
export enum Classification {
  ...
  /**
   * CLASSIFICATION_PLATFORM - A runtime environment that interprets or executes software.
...
export enum ExternalReferenceType {
  ...
  /** EXTERNAL_REFERENCE_TYPE_FORMULATION - Describes the formulation of any referencable object within the BOM, including components, services, metadata, declarations, or the BOM itself. */
  ...
  /** EXTERNAL_REFERENCE_TYPE_PATENT_FAMILY - References information about a patent family which may be defined in human-readable documents or in machine-readable formats such as CycloneDX or ST.96. A patent family is a group of related patent applications or granted patents that cover the same or similar invention. For detailed patent family information or to reference the information provided directly by patent offices, it is recommended to leverage standards from the World Intellectual Property Organization (WIPO) such as [ST.96](https://www.wipo.int/standards/en/st96). */
  EXTERNAL_REFERENCE_TYPE_PATENT_FAMILY = 44,
  /** EXTERNAL_REFERENCE_TYPE_PATENT_ASSERTION - References assertions made regarding patents associated with a component or service. Assertions distinguish between ownership, licensing, and other relevant interactions with patents. */
  EXTERNAL_REFERENCE_TYPE_PATENT_ASSERTION = 45,
  /** EXTERNAL_REFERENCE_TYPE_CITATION - A reference to external citations applicable to the object identified by this BOM entry or the BOM itself. When used with a BOM-Link, this allows offloading citations into a separate CycloneDX BOM. */
...
export function externalReferenceTypeFromJSON(object: any): ExternalReferenceType {
  switch (object) {
    ...
    case 43:
    case "EXTERNAL_REFERENCE_TYPE_PATENT":
      return ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_PATENT;
    case 44:
    case "EXTERNAL_REFERENCE_TYPE_PATENT_FAMILY":
      return ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_PATENT_FAMILY;
    case 45:
    case "EXTERNAL_REFERENCE_TYPE_PATENT_ASSERTION":
      return ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_PATENT_ASSERTION;
    case 46:
    case "EXTERNAL_REFERENCE_TYPE_CITATION":
      return ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_CITATION;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function externalReferenceTypeToJSON(object: ExternalReferenceType): string {
  switch (object) {
    ...
    case ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_PATENT:
      return "EXTERNAL_REFERENCE_TYPE_PATENT";
    case ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_PATENT_FAMILY:
      return "EXTERNAL_REFERENCE_TYPE_PATENT_FAMILY";
    case ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_PATENT_ASSERTION:
      return "EXTERNAL_REFERENCE_TYPE_PATENT_ASSERTION";
    case ExternalReferenceType.EXTERNAL_REFERENCE_TYPE_CITATION:
      return "EXTERNAL_REFERENCE_TYPE_CITATION";
...
export function hashAlgFromJSON(object: any): HashAlg {
  switch (object) {
    ...
    case 13:
    case "HASH_ALG_STREEBOG_256":
      return HashAlg.HASH_ALG_STREEBOG_256;
    case 14:
    case "HASH_ALG_STREEBOG_512":
      return HashAlg.HASH_ALG_STREEBOG_512;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function hashAlgToJSON(object: HashAlg): string {
  switch (object) {
    ...
    case HashAlg.HASH_ALG_STREEBOG_256:
      return "HASH_ALG_STREEBOG_256";
    case HashAlg.HASH_ALG_STREEBOG_512:
      return "HASH_ALG_STREEBOG_512";
...
export enum TlpClassification {
  /**
   * TLP_CLASSIFICATION_CLEAR - The information is not subject to any restrictions as regards the sharing.
   * buf:lint:ignore ENUM_ZERO_VALUE_SUFFIX -- "CLEAR" is our fallback, the default.
   */
  TLP_CLASSIFICATION_CLEAR = 0,
  /** TLP_CLASSIFICATION_GREEN - The information is subject to limited disclosure, and recipients can share it within their community but not via publicly accessible channels. */
  TLP_CLASSIFICATION_GREEN = 1,
  /** TLP_CLASSIFICATION_AMBER - The information is subject to limited disclosure, and recipients can only share it on a need-to-know basis within their organization and with clients. */
  TLP_CLASSIFICATION_AMBER = 2,
  /** TLP_CLASSIFICATION_AMBER_AND_STRICT - The information is subject to limited disclosure, and recipients can only share it on a need-to-know basis within their organization. */
  TLP_CLASSIFICATION_AMBER_AND_STRICT = 3,
  /** TLP_CLASSIFICATION_RED - The information is subject to restricted distribution to individual recipients only and must not be shared. */
  TLP_CLASSIFICATION_RED = 4,
  UNRECOGNIZED = -1,
}

export function tlpClassificationFromJSON(object: any): TlpClassification {
  switch (object) {
    case 0:
    case "TLP_CLASSIFICATION_CLEAR":
      return TlpClassification.TLP_CLASSIFICATION_CLEAR;
    case 1:
    case "TLP_CLASSIFICATION_GREEN":
      return TlpClassification.TLP_CLASSIFICATION_GREEN;
    case 2:
    case "TLP_CLASSIFICATION_AMBER":
      return TlpClassification.TLP_CLASSIFICATION_AMBER;
    case 3:
    case "TLP_CLASSIFICATION_AMBER_AND_STRICT":
      return TlpClassification.TLP_CLASSIFICATION_AMBER_AND_STRICT;
    case 4:
    case "TLP_CLASSIFICATION_RED":
      return TlpClassification.TLP_CLASSIFICATION_RED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return TlpClassification.UNRECOGNIZED;
  }
}

export function tlpClassificationToJSON(object: TlpClassification): string {
  switch (object) {
    case TlpClassification.TLP_CLASSIFICATION_CLEAR:
      return "TLP_CLASSIFICATION_CLEAR";
    case TlpClassification.TLP_CLASSIFICATION_GREEN:
      return "TLP_CLASSIFICATION_GREEN";
    case TlpClassification.TLP_CLASSIFICATION_AMBER:
      return "TLP_CLASSIFICATION_AMBER";
    case TlpClassification.TLP_CLASSIFICATION_AMBER_AND_STRICT:
      return "TLP_CLASSIFICATION_AMBER_AND_STRICT";
    case TlpClassification.TLP_CLASSIFICATION_RED:
      return "TLP_CLASSIFICATION_RED";
    case TlpClassification.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export enum ModelParameterApproachType {
  /**
   * MODEL_PARAMETER_APPROACH_TYPE_SUPERVISED - Supervised machine learning involves training an algorithm on labeled data to predict or classify new data based on the patterns learned from the labeled examples.
   * buf:lint:ignore ENUM_ZERO_VALUE_SUFFIX -- value `0` is a fallback(meaning "unspecified") in protobuf3. this usage here is an error, it shall be fixed with v2.0 of this very schema
   */
...
export enum PatentLegalStatus {
  /** PATENT_LEGAL_STATUS_UNSPECIFIED - Default */
  PATENT_LEGAL_STATUS_UNSPECIFIED = 0,
  /** PATENT_LEGAL_STATUS_PENDING - The patent application has been filed but not yet examined or granted. */
  PATENT_LEGAL_STATUS_PENDING = 1,
  /** PATENT_LEGAL_STATUS_GRANTED - The patent application has been examined and a patent has been issued. */
  PATENT_LEGAL_STATUS_GRANTED = 2,
  /** PATENT_LEGAL_STATUS_REVOKED - The patent has been declared invalid through a legal or administrative process. */
  PATENT_LEGAL_STATUS_REVOKED = 3,
  /** PATENT_LEGAL_STATUS_EXPIRED - The patent has reached the end of its enforceable term. */
  PATENT_LEGAL_STATUS_EXPIRED = 4,
  /** PATENT_LEGAL_STATUS_LAPSED - The patent is no longer in force due to non-payment of maintenance fees or other requirements. */
  PATENT_LEGAL_STATUS_LAPSED = 5,
  /** PATENT_LEGAL_STATUS_WITHDRAWN - The patent application was voluntarily withdrawn by the applicant. */
  PATENT_LEGAL_STATUS_WITHDRAWN = 6,
  /** PATENT_LEGAL_STATUS_ABANDONED - The patent application was abandoned, often due to lack of action or response. */
  PATENT_LEGAL_STATUS_ABANDONED = 7,
  /** PATENT_LEGAL_STATUS_SUSPENDED - Processing of the patent application has been temporarily halted. */
  PATENT_LEGAL_STATUS_SUSPENDED = 8,
  /** PATENT_LEGAL_STATUS_REINSTATED - A previously abandoned or lapsed patent has been reinstated. */
  PATENT_LEGAL_STATUS_REINSTATED = 9,
  /** PATENT_LEGAL_STATUS_OPPOSED - The patent application or granted patent is under formal opposition proceedings. */
  PATENT_LEGAL_STATUS_OPPOSED = 10,
  /** PATENT_LEGAL_STATUS_TERMINATED - The patent or application has been officially terminated. */
  PATENT_LEGAL_STATUS_TERMINATED = 11,
  /** PATENT_LEGAL_STATUS_INVALIDATED - The patent has been invalidated, either in part or in full. */
  PATENT_LEGAL_STATUS_INVALIDATED = 12,
  /** PATENT_LEGAL_STATUS_IN_FORCE - The granted patent is active and enforceable. */
  PATENT_LEGAL_STATUS_IN_FORCE = 13,
  UNRECOGNIZED = -1,
}

export function patentLegalStatusFromJSON(object: any): PatentLegalStatus {
  switch (object) {
    case 0:
    case "PATENT_LEGAL_STATUS_UNSPECIFIED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_UNSPECIFIED;
    case 1:
    case "PATENT_LEGAL_STATUS_PENDING":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_PENDING;
    case 2:
    case "PATENT_LEGAL_STATUS_GRANTED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_GRANTED;
    case 3:
    case "PATENT_LEGAL_STATUS_REVOKED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_REVOKED;
    case 4:
    case "PATENT_LEGAL_STATUS_EXPIRED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_EXPIRED;
    case 5:
    case "PATENT_LEGAL_STATUS_LAPSED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_LAPSED;
    case 6:
    case "PATENT_LEGAL_STATUS_WITHDRAWN":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_WITHDRAWN;
    case 7:
    case "PATENT_LEGAL_STATUS_ABANDONED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_ABANDONED;
    case 8:
    case "PATENT_LEGAL_STATUS_SUSPENDED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_SUSPENDED;
    case 9:
    case "PATENT_LEGAL_STATUS_REINSTATED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_REINSTATED;
    case 10:
    case "PATENT_LEGAL_STATUS_OPPOSED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_OPPOSED;
    case 11:
    case "PATENT_LEGAL_STATUS_TERMINATED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_TERMINATED;
    case 12:
    case "PATENT_LEGAL_STATUS_INVALIDATED":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_INVALIDATED;
    case 13:
    case "PATENT_LEGAL_STATUS_IN_FORCE":
      return PatentLegalStatus.PATENT_LEGAL_STATUS_IN_FORCE;
    case -1:
    case "UNRECOGNIZED":
    default:
      return PatentLegalStatus.UNRECOGNIZED;
  }
}

export function patentLegalStatusToJSON(object: PatentLegalStatus): string {
  switch (object) {
    case PatentLegalStatus.PATENT_LEGAL_STATUS_UNSPECIFIED:
      return "PATENT_LEGAL_STATUS_UNSPECIFIED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_PENDING:
      return "PATENT_LEGAL_STATUS_PENDING";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_GRANTED:
      return "PATENT_LEGAL_STATUS_GRANTED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_REVOKED:
      return "PATENT_LEGAL_STATUS_REVOKED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_EXPIRED:
      return "PATENT_LEGAL_STATUS_EXPIRED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_LAPSED:
      return "PATENT_LEGAL_STATUS_LAPSED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_WITHDRAWN:
      return "PATENT_LEGAL_STATUS_WITHDRAWN";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_ABANDONED:
      return "PATENT_LEGAL_STATUS_ABANDONED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_SUSPENDED:
      return "PATENT_LEGAL_STATUS_SUSPENDED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_REINSTATED:
      return "PATENT_LEGAL_STATUS_REINSTATED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_OPPOSED:
      return "PATENT_LEGAL_STATUS_OPPOSED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_TERMINATED:
      return "PATENT_LEGAL_STATUS_TERMINATED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_INVALIDATED:
      return "PATENT_LEGAL_STATUS_INVALIDATED";
    case PatentLegalStatus.PATENT_LEGAL_STATUS_IN_FORCE:
      return "PATENT_LEGAL_STATUS_IN_FORCE";
    case PatentLegalStatus.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export enum PatentAssertionType {
  /** PATENT_ASSERTION_TYPE_UNSPECIFIED - Default */
  PATENT_ASSERTION_TYPE_UNSPECIFIED = 0,
  /** PATENT_ASSERTION_TYPE_OWNERSHIP - The manufacturer asserts ownership of the patent or patent family. */
  PATENT_ASSERTION_TYPE_OWNERSHIP = 1,
  /** PATENT_ASSERTION_TYPE_LICENSE - The manufacturer asserts they have a license to use the patent or patent family. */
  PATENT_ASSERTION_TYPE_LICENSE = 2,
  /** PATENT_ASSERTION_TYPE_THIRD_PARTY_CLAIM - A third party has asserted a claim or potential infringement against the manufacturer’s component or service. */
  PATENT_ASSERTION_TYPE_THIRD_PARTY_CLAIM = 3,
  /** PATENT_ASSERTION_TYPE_STANDARDS_INCLUSION - The patent is part of a standard essential patent (SEP) portfolio relevant to the component or service. */
  PATENT_ASSERTION_TYPE_STANDARDS_INCLUSION = 4,
  /** PATENT_ASSERTION_TYPE_PRIOR_ART - The manufacturer asserts the patent or patent family as prior art that invalidates another patent or claim. */
  PATENT_ASSERTION_TYPE_PRIOR_ART = 5,
  /** PATENT_ASSERTION_TYPE_EXCLUSIVE_RIGHTS - The manufacturer asserts exclusive rights granted through a licensing agreement. */
  PATENT_ASSERTION_TYPE_EXCLUSIVE_RIGHTS = 6,
  /** PATENT_ASSERTION_TYPE_NON_ASSERTION - he manufacturer asserts they will not enforce the patent or patent family against certain uses or users. */
  PATENT_ASSERTION_TYPE_NON_ASSERTION = 7,
  /** PATENT_ASSERTION_TYPE_RESEARCH_OR_EVALUATION - The patent or patent family is being used under a research or evaluation license. */
  PATENT_ASSERTION_TYPE_RESEARCH_OR_EVALUATION = 8,
  UNRECOGNIZED = -1,
}

export function patentAssertionTypeFromJSON(object: any): PatentAssertionType {
  switch (object) {
    case 0:
    case "PATENT_ASSERTION_TYPE_UNSPECIFIED":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_UNSPECIFIED;
    case 1:
    case "PATENT_ASSERTION_TYPE_OWNERSHIP":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_OWNERSHIP;
    case 2:
    case "PATENT_ASSERTION_TYPE_LICENSE":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_LICENSE;
    case 3:
    case "PATENT_ASSERTION_TYPE_THIRD_PARTY_CLAIM":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_THIRD_PARTY_CLAIM;
    case 4:
    case "PATENT_ASSERTION_TYPE_STANDARDS_INCLUSION":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_STANDARDS_INCLUSION;
    case 5:
    case "PATENT_ASSERTION_TYPE_PRIOR_ART":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_PRIOR_ART;
    case 6:
    case "PATENT_ASSERTION_TYPE_EXCLUSIVE_RIGHTS":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_EXCLUSIVE_RIGHTS;
    case 7:
    case "PATENT_ASSERTION_TYPE_NON_ASSERTION":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_NON_ASSERTION;
    case 8:
    case "PATENT_ASSERTION_TYPE_RESEARCH_OR_EVALUATION":
      return PatentAssertionType.PATENT_ASSERTION_TYPE_RESEARCH_OR_EVALUATION;
    case -1:
    case "UNRECOGNIZED":
    default:
      return PatentAssertionType.UNRECOGNIZED;
  }
}

export function patentAssertionTypeToJSON(object: PatentAssertionType): string {
  switch (object) {
    case PatentAssertionType.PATENT_ASSERTION_TYPE_UNSPECIFIED:
      return "PATENT_ASSERTION_TYPE_UNSPECIFIED";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_OWNERSHIP:
      return "PATENT_ASSERTION_TYPE_OWNERSHIP";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_LICENSE:
      return "PATENT_ASSERTION_TYPE_LICENSE";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_THIRD_PARTY_CLAIM:
      return "PATENT_ASSERTION_TYPE_THIRD_PARTY_CLAIM";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_STANDARDS_INCLUSION:
      return "PATENT_ASSERTION_TYPE_STANDARDS_INCLUSION";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_PRIOR_ART:
      return "PATENT_ASSERTION_TYPE_PRIOR_ART";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_EXCLUSIVE_RIGHTS:
      return "PATENT_ASSERTION_TYPE_EXCLUSIVE_RIGHTS";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_NON_ASSERTION:
      return "PATENT_ASSERTION_TYPE_NON_ASSERTION";
    case PatentAssertionType.PATENT_ASSERTION_TYPE_RESEARCH_OR_EVALUATION:
      return "PATENT_ASSERTION_TYPE_RESEARCH_OR_EVALUATION";
    case PatentAssertionType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
 ...
 */
export interface LicenseExpressionDetailed {
  /**
   * A valid SPDX license expression. Refer to https://spdx.org/specifications for syntax requirements.
   * Example values:
 ...
 */
export interface LicenseExpressionDetailed_ExpressionDetails {
  /**
...
export interface Metadata_DistributionConstraints {
...
export enum CryptoProperties_AlgorithmProperties_CryptoPrimitive {
  ...
  /** CRYPTO_PRIMITIVE_KEY_WRAP - Key-wrap is a cryptographic technique used to securely encrypt and protect cryptographic keys using algorithms like AES. */
...
export function cryptoProperties_AlgorithmProperties_CryptoPrimitiveFromJSON(
  ...
  switch (object) {
    ...
    case 16:
    case "CRYPTO_PRIMITIVE_KEY_WRAP":
      return CryptoProperties_AlgorithmProperties_CryptoPrimitive.CRYPTO_PRIMITIVE_KEY_WRAP;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function cryptoProperties_AlgorithmProperties_CryptoPrimitiveToJSON(
  ...
  switch (object) {
    ...
    case CryptoProperties_AlgorithmProperties_CryptoPrimitive.CRYPTO_PRIMITIVE_KEY_WRAP:
      return "CRYPTO_PRIMITIVE_KEY_WRAP";
...
/** Certificate State */
export interface CryptoProperties_CertificateState {
  ...
  predefinedState?:
    | CryptoProperties_CertificateState_PredefinedState
    | undefined;
...
export enum CryptoProperties_CertificateState_PredefinedState {
  /** PREDEFINED_STATE_UNSPECIFIED - ProtoBuff's default value */
  PREDEFINED_STATE_UNSPECIFIED = 0,
  /** PREDEFINED_STATE_PRE_ACTIVATION - The certificate has been issued by the issuing certificate authority (CA) but has not been authorized for use. */
  PREDEFINED_STATE_PRE_ACTIVATION = 1,
  /** PREDEFINED_STATE_ACTIVE - The certificate may be used to cryptographically protect information, cryptographically process previously protected information, or both. */
  PREDEFINED_STATE_ACTIVE = 2,
  /** PREDEFINED_STATE_SUSPENDED - The use of a certificate may be suspended for several possible reasons. */
  PREDEFINED_STATE_SUSPENDED = 3,
  /** PREDEFINED_STATE_DEACTIVATED - Certificates in the deactivated state shall not be used to apply cryptographic protection but, in some cases, may be used to process cryptographically protected information. */
  PREDEFINED_STATE_DEACTIVATED = 4,
  /** PREDEFINED_STATE_REVOKED - A revoked certificate is a digital certificate that has been invalidated by the issuing certificate authority (CA) before its scheduled expiration date. */
  PREDEFINED_STATE_REVOKED = 5,
  /** PREDEFINED_STATE_DESTROYED - The certificate has been destroyed. */
  PREDEFINED_STATE_DESTROYED = 6,
  UNRECOGNIZED = -1,
}

export function cryptoProperties_CertificateState_PredefinedStateFromJSON(
  object: any,
): CryptoProperties_CertificateState_PredefinedState {
  switch (object) {
    case 0:
    case "PREDEFINED_STATE_UNSPECIFIED":
      return CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_UNSPECIFIED;
    case 1:
    case "PREDEFINED_STATE_PRE_ACTIVATION":
      return CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_PRE_ACTIVATION;
    case 2:
    case "PREDEFINED_STATE_ACTIVE":
      return CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_ACTIVE;
    case 3:
    case "PREDEFINED_STATE_SUSPENDED":
      return CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_SUSPENDED;
    case 4:
    case "PREDEFINED_STATE_DEACTIVATED":
      return CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_DEACTIVATED;
    case 5:
    case "PREDEFINED_STATE_REVOKED":
      return CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_REVOKED;
    case 6:
    case "PREDEFINED_STATE_DESTROYED":
      return CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_DESTROYED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return CryptoProperties_CertificateState_PredefinedState.UNRECOGNIZED;
  }
}

export function cryptoProperties_CertificateState_PredefinedStateToJSON(
  object: CryptoProperties_CertificateState_PredefinedState,
): string {
  switch (object) {
    case CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_UNSPECIFIED:
      return "PREDEFINED_STATE_UNSPECIFIED";
    case CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_PRE_ACTIVATION:
      return "PREDEFINED_STATE_PRE_ACTIVATION";
    case CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_ACTIVE:
      return "PREDEFINED_STATE_ACTIVE";
    case CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_SUSPENDED:
      return "PREDEFINED_STATE_SUSPENDED";
    case CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_DEACTIVATED:
      return "PREDEFINED_STATE_DEACTIVATED";
    case CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_REVOKED:
      return "PREDEFINED_STATE_REVOKED";
    case CryptoProperties_CertificateState_PredefinedState.PREDEFINED_STATE_DESTROYED:
      return "PREDEFINED_STATE_DESTROYED";
    case CryptoProperties_CertificateState_PredefinedState.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface CryptoProperties_CertificateProperties {
  ...
  certificateExtensions?:
    | CryptoProperties_CertificateExtensions
    | undefined;
...
export interface CryptoProperties_CertificateExtensions {
...
export enum CryptoProperties_CertificateExtensions_CommonExtensionName {
  /** COMMON_EXTENSION_NAME_UNSPECIFIED - ProtoBuff's default value */
...
export function cryptoProperties_CertificateExtensions_CommonExtensionNameFromJSON(
  object: any,
): CryptoProperties_CertificateExtensions_CommonExtensionName {
  switch (object) {
    case 0:
    case "COMMON_EXTENSION_NAME_UNSPECIFIED":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_UNSPECIFIED;
    case 1:
    case "COMMON_EXTENSION_NAME_BASIC_CONSTRAINTS":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_BASIC_CONSTRAINTS;
    case 2:
    case "COMMON_EXTENSION_NAME_KEY_USAGE":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_KEY_USAGE;
    case 3:
    case "COMMON_EXTENSION_NAME_EXTENDED_KEY_USAGE":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_EXTENDED_KEY_USAGE;
    case 4:
    case "COMMON_EXTENSION_NAME_SUBJECT_ALTERNATIVE_NAME":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_SUBJECT_ALTERNATIVE_NAME;
    case 5:
    case "COMMON_EXTENSION_NAME_AUTHORITY_KEY_IDENTIFIER":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_AUTHORITY_KEY_IDENTIFIER;
    case 6:
    case "COMMON_EXTENSION_NAME_SUBJECT_KEY_IDENTIFIER":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_SUBJECT_KEY_IDENTIFIER;
    case 7:
    case "COMMON_EXTENSION_NAME_AUTHORITY_INFORMATION_ACCESS":
      return CryptoProperties_CertificateExtensions_CommonExtensionName
        .COMMON_EXTENSION_NAME_AUTHORITY_INFORMATION_ACCESS;
    case 8:
    case "COMMON_EXTENSION_NAME_CERTIFICATE_POLICIES":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_CERTIFICATE_POLICIES;
    case 9:
    case "COMMON_EXTENSION_NAME_CRL_DISTRIBUTION_POINTS":
      return CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_CRL_DISTRIBUTION_POINTS;
    case 10:
    case "COMMON_EXTENSION_NAME_SIGNED_CERTIFICATE_TIMESTAMP":
      return CryptoProperties_CertificateExtensions_CommonExtensionName
        .COMMON_EXTENSION_NAME_SIGNED_CERTIFICATE_TIMESTAMP;
    case -1:
    case "UNRECOGNIZED":
    default:
      return CryptoProperties_CertificateExtensions_CommonExtensionName.UNRECOGNIZED;
  }
}

export function cryptoProperties_CertificateExtensions_CommonExtensionNameToJSON(
  object: CryptoProperties_CertificateExtensions_CommonExtensionName,
): string {
  switch (object) {
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_UNSPECIFIED:
      return "COMMON_EXTENSION_NAME_UNSPECIFIED";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_BASIC_CONSTRAINTS:
      return "COMMON_EXTENSION_NAME_BASIC_CONSTRAINTS";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_KEY_USAGE:
      return "COMMON_EXTENSION_NAME_KEY_USAGE";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_EXTENDED_KEY_USAGE:
      return "COMMON_EXTENSION_NAME_EXTENDED_KEY_USAGE";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_SUBJECT_ALTERNATIVE_NAME:
      return "COMMON_EXTENSION_NAME_SUBJECT_ALTERNATIVE_NAME";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_AUTHORITY_KEY_IDENTIFIER:
      return "COMMON_EXTENSION_NAME_AUTHORITY_KEY_IDENTIFIER";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_SUBJECT_KEY_IDENTIFIER:
      return "COMMON_EXTENSION_NAME_SUBJECT_KEY_IDENTIFIER";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_AUTHORITY_INFORMATION_ACCESS:
      return "COMMON_EXTENSION_NAME_AUTHORITY_INFORMATION_ACCESS";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_CERTIFICATE_POLICIES:
      return "COMMON_EXTENSION_NAME_CERTIFICATE_POLICIES";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_CRL_DISTRIBUTION_POINTS:
      return "COMMON_EXTENSION_NAME_CRL_DISTRIBUTION_POINTS";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.COMMON_EXTENSION_NAME_SIGNED_CERTIFICATE_TIMESTAMP:
      return "COMMON_EXTENSION_NAME_SIGNED_CERTIFICATE_TIMESTAMP";
    case CryptoProperties_CertificateExtensions_CommonExtensionName.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface CryptoProperties_CertificateExtensions_Extension {
  /** Common extension with predefined name */
  commonExtension?:
    | CryptoProperties_CertificateExtensions_CommonExtension
    | undefined;
  /** Custom extension with user-defined name */
  customExtension?: CryptoProperties_CertificateExtensions_CustomExtension | undefined;
}

/** Common extension with predefined name */
export interface CryptoProperties_CertificateExtensions_CommonExtension {
...
/** Custom extension with user-defined name */
export interface CryptoProperties_CertificateExtensions_CustomExtension {
...
export interface CryptoProperties_RelatedCryptographicAssets {
...
export interface CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset {
...
export enum CryptoProperties_ProtocolProperties_CryptoProtocolType {
  ...
  /** CRYPTO_PROTOCOL_TYPE_DTLS - Datagram Transport Layer Security */
  CRYPTO_PROTOCOL_TYPE_DTLS = 9,
  /** CRYPTO_PROTOCOL_TYPE_QUIC - Quick UDP Internet Connections */
  CRYPTO_PROTOCOL_TYPE_QUIC = 10,
  /** CRYPTO_PROTOCOL_TYPE_EAP_AKA - Extensible Authentication Protocol variant */
  CRYPTO_PROTOCOL_TYPE_EAP_AKA = 11,
  /** CRYPTO_PROTOCOL_TYPE_EAP_AKA_PRIME - Enhanced version of EAP-AKA */
  CRYPTO_PROTOCOL_TYPE_EAP_AKA_PRIME = 12,
  /** CRYPTO_PROTOCOL_TYPE_PRINS - Protection of Inter-Network Signaling */
  CRYPTO_PROTOCOL_TYPE_PRINS = 13,
  /** CRYPTO_PROTOCOL_TYPE_5G_AKA - Authentication and Key Agreement for 5G */
...
export function cryptoProperties_ProtocolProperties_CryptoProtocolTypeFromJSON(
  ...
  switch (object) {
    ...
    case 9:
    case "CRYPTO_PROTOCOL_TYPE_DTLS":
      return CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_DTLS;
    case 10:
    case "CRYPTO_PROTOCOL_TYPE_QUIC":
      return CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_QUIC;
    case 11:
    case "CRYPTO_PROTOCOL_TYPE_EAP_AKA":
      return CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_EAP_AKA;
    case 12:
    case "CRYPTO_PROTOCOL_TYPE_EAP_AKA_PRIME":
      return CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_EAP_AKA_PRIME;
    case 13:
    case "CRYPTO_PROTOCOL_TYPE_PRINS":
      return CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_PRINS;
    case 14:
    case "CRYPTO_PROTOCOL_TYPE_5G_AKA":
      return CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_5G_AKA;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function cryptoProperties_ProtocolProperties_CryptoProtocolTypeToJSON(
  ...
  switch (object) {
    ...
    case CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_DTLS:
      return "CRYPTO_PROTOCOL_TYPE_DTLS";
    case CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_QUIC:
      return "CRYPTO_PROTOCOL_TYPE_QUIC";
    case CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_EAP_AKA:
      return "CRYPTO_PROTOCOL_TYPE_EAP_AKA";
    case CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_EAP_AKA_PRIME:
      return "CRYPTO_PROTOCOL_TYPE_EAP_AKA_PRIME";
    case CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_PRINS:
      return "CRYPTO_PROTOCOL_TYPE_PRINS";
    case CryptoProperties_ProtocolProperties_CryptoProtocolType.CRYPTO_PROTOCOL_TYPE_5G_AKA:
      return "CRYPTO_PROTOCOL_TYPE_5G_AKA";
...
export interface CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed {
  /** Transform Type 1: encryption algorithms */
...
export interface CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr {
...
export interface CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf {
...
export interface CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ {
...
export interface CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke {
...
/** IKEv2 Authentication method */
export interface CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth {
...
export interface PatentOrFamily {
  /** An individual patent */
  patent?:
    | Patent
    | undefined;
  /** A patent family */
  patentFamily?: PatentFamily | undefined;
}
...
export interface PatentAssertion {
  /** A identifier which can be used to reference the component elsewhere in the BOM. Uniqueness is enforced within all elements and children of the root-level bom element. */
  bomRef?:
    | string
    | undefined;
...
export interface Citation_Pointers {
  /**
...
export interface Citation_Expressions {
  /**
...
export const Bom: MessageFns<Bom> = {
  encode(message: Bom, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.citations) {
      Citation.encode(v!, writer.uint32(130).fork()).join();
    }
    return writer;
  },
...
export const Component: MessageFns<Component> = {
  encode(message: Component, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.versionRange !== undefined) {
      writer.uint32(266).string(message.versionRange);
    }
    ...
    if (message.isExternal !== undefined) {
      writer.uint32(272).bool(message.isExternal);
    }
    for (const v of message.patentAssertions) {
      PatentAssertion.encode(v!, writer.uint32(282).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 35: {
          ...
          message.patentAssertions.push(PatentAssertion.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Component {
    return {
      ...
      versionRange: isSet(object.versionRange) ? globalThis.String(object.versionRange) : undefined,
      ...
      swhid: globalThis.Array.isArray(object?.swhid)
        ...
        : [],
      isExternal: isSet(object.isExternal) ? globalThis.Boolean(object.isExternal) : undefined,
      patentAssertions: globalThis.Array.isArray(object?.patentAssertions)
        ? object.patentAssertions.map((e: any) => PatentAssertion.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: Component): unknown {
    ...
    if (message.patentAssertions?.length) {
      obj.patentAssertions = message.patentAssertions.map((e) => PatentAssertion.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Component>, I>>(object: I): Component {
    ...
    message.versionRange = object.versionRange ?? undefined;
    ...
    message.patentAssertions = object.patentAssertions?.map((e) => PatentAssertion.fromPartial(e)) || [];
    return message;
  },
};
...
function createBaseExternalReference(): ExternalReference {
  return { type: 0, url: "", comment: undefined, hashes: [], properties: [] };
}
...
export const LicenseChoice: MessageFns<LicenseChoice> = {
  encode(message: LicenseChoice, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.expressionDetailed !== undefined) {
      LicenseExpressionDetailed.encode(message.expressionDetailed, writer.uint32(42).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.expressionDetailed = LicenseExpressionDetailed.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 24) {
  ...
  fromJSON(object: any): LicenseChoice {
    return {
      ...
      expressionDetailed: isSet(object.expressionDetailed)
        ? LicenseExpressionDetailed.fromJSON(object.expressionDetailed)
        : undefined,
  ...
  toJSON(message: LicenseChoice): unknown {
    ...
    if (message.expressionDetailed !== undefined) {
      obj.expressionDetailed = LicenseExpressionDetailed.toJSON(message.expressionDetailed);
    }
    if (message.acknowledgement !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<LicenseChoice>, I>>(object: I): LicenseChoice {
    ...
    message.expressionDetailed = (object.expressionDetailed !== undefined && object.expressionDetailed !== null)
      ? LicenseExpressionDetailed.fromPartial(object.expressionDetailed)
      : undefined;
...
function createBaseLicenseExpressionDetailed(): LicenseExpressionDetailed {
  return {
    expression: "",
    details: [],
    bomRef: undefined,
...
export const LicenseExpressionDetailed: MessageFns<LicenseExpressionDetailed> = {
  encode(message: LicenseExpressionDetailed, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.expression !== "") {
      writer.uint32(10).string(message.expression);
    }
    for (const v of message.details) {
      LicenseExpressionDetailed_ExpressionDetails.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.bomRef !== undefined) {
      writer.uint32(26).string(message.bomRef);
    }
    if (message.acknowledgement !== undefined) {
      writer.uint32(32).int32(message.acknowledgement);
    }
    if (message.licensing !== undefined) {
      Licensing.encode(message.licensing, writer.uint32(42).fork()).join();
    }
    for (const v of message.properties) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LicenseExpressionDetailed {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLicenseExpressionDetailed();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.details.push(LicenseExpressionDetailed_ExpressionDetails.decode(reader, reader.uint32()));
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): LicenseExpressionDetailed {
    return {
      expression: isSet(object.expression) ? globalThis.String(object.expression) : "",
      details: globalThis.Array.isArray(object?.details)
        ? object.details.map((e: any) => LicenseExpressionDetailed_ExpressionDetails.fromJSON(e))
        : [],
      bomRef: isSet(object.bomRef) ? globalThis.String(object.bomRef) : undefined,
      acknowledgement: isSet(object.acknowledgement)
        ? licenseAcknowledgementEnumerationFromJSON(object.acknowledgement)
  ...
  toJSON(message: LicenseExpressionDetailed): unknown {
    const obj: any = {};
    if (message.expression !== "") {
      obj.expression = message.expression;
    }
    if (message.details?.length) {
      obj.details = message.details.map((e) => LicenseExpressionDetailed_ExpressionDetails.toJSON(e));
    }
    if (message.bomRef !== undefined) {
      obj.bomRef = message.bomRef;
    }
  ...
  create<I extends Exact<DeepPartial<LicenseExpressionDetailed>, I>>(base?: I): LicenseExpressionDetailed {
    return LicenseExpressionDetailed.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LicenseExpressionDetailed>, I>>(object: I): LicenseExpressionDetailed {
    const message = createBaseLicenseExpressionDetailed();
    message.expression = object.expression ?? "";
    message.details = object.details?.map((e) => LicenseExpressionDetailed_ExpressionDetails.fromPartial(e)) || [];
    message.bomRef = object.bomRef ?? undefined;
    message.acknowledgement = object.acknowledgement ?? undefined;
    message.licensing = (object.licensing !== undefined && object.licensing !== null)
      ? Licensing.fromPartial(object.licensing)
...
function createBaseLicenseExpressionDetailed_ExpressionDetails(): LicenseExpressionDetailed_ExpressionDetails {
  return { licenseIdentifier: "", bomRef: undefined, text: undefined, url: undefined };
}

export const LicenseExpressionDetailed_ExpressionDetails: MessageFns<LicenseExpressionDetailed_ExpressionDetails> = {
  encode(
    message: LicenseExpressionDetailed_ExpressionDetails,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.licenseIdentifier !== "") {
      writer.uint32(10).string(message.licenseIdentifier);
    }
    if (message.bomRef !== undefined) {
      writer.uint32(18).string(message.bomRef);
    }
    if (message.text !== undefined) {
      AttachedText.encode(message.text, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LicenseExpressionDetailed_ExpressionDetails {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLicenseExpressionDetailed_ExpressionDetails();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.licenseIdentifier = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): LicenseExpressionDetailed_ExpressionDetails {
    return {
      licenseIdentifier: isSet(object.licenseIdentifier) ? globalThis.String(object.licenseIdentifier) : "",
      bomRef: isSet(object.bomRef) ? globalThis.String(object.bomRef) : undefined,
      text: isSet(object.text) ? AttachedText.fromJSON(object.text) : undefined,
      url: isSet(object.url) ? globalThis.String(object.url) : undefined,
    };
  ...
  toJSON(message: LicenseExpressionDetailed_ExpressionDetails): unknown {
    const obj: any = {};
    if (message.licenseIdentifier !== "") {
      obj.licenseIdentifier = message.licenseIdentifier;
    }
    if (message.bomRef !== undefined) {
      obj.bomRef = message.bomRef;
    }
  ...
  create<I extends Exact<DeepPartial<LicenseExpressionDetailed_ExpressionDetails>, I>>(
    base?: I,
  ): LicenseExpressionDetailed_ExpressionDetails {
    return LicenseExpressionDetailed_ExpressionDetails.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LicenseExpressionDetailed_ExpressionDetails>, I>>(
    object: I,
  ): LicenseExpressionDetailed_ExpressionDetails {
    const message = createBaseLicenseExpressionDetailed_ExpressionDetails();
    message.licenseIdentifier = object.licenseIdentifier ?? "";
    message.bomRef = object.bomRef ?? undefined;
    message.text = (object.text !== undefined && object.text !== null)
      ? AttachedText.fromPartial(object.text)
      : undefined;
...
function createBaseMetadata(): Metadata {
  return {
    ...
    lifecycles: [],
    manufacturer: undefined,
    distributionConstraints: undefined,
  };
}
...
export const Metadata: MessageFns<Metadata> = {
  encode(message: Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.distributionConstraints !== undefined) {
      Metadata_DistributionConstraints.encode(message.distributionConstraints, writer.uint32(90).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          message.distributionConstraints = Metadata_DistributionConstraints.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Metadata {
    return {
      ...
      lifecycles: globalThis.Array.isArray(object?.lifecycles)
        ...
        : [],
      manufacturer: isSet(object.manufacturer) ? OrganizationalEntity.fromJSON(object.manufacturer) : undefined,
      distributionConstraints: isSet(object.distributionConstraints)
        ? Metadata_DistributionConstraints.fromJSON(object.distributionConstraints)
        : undefined,
    };
  },
  ...
  toJSON(message: Metadata): unknown {
    ...
    if (message.distributionConstraints !== undefined) {
      obj.distributionConstraints = Metadata_DistributionConstraints.toJSON(message.distributionConstraints);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Metadata>, I>>(object: I): Metadata {
    ...
    message.distributionConstraints =
      (object.distributionConstraints !== undefined && object.distributionConstraints !== null)
        ? Metadata_DistributionConstraints.fromPartial(object.distributionConstraints)
        : undefined;
    return message;
  },
};

function createBaseMetadata_DistributionConstraints(): Metadata_DistributionConstraints {
  return { tlp: undefined };
}

export const Metadata_DistributionConstraints: MessageFns<Metadata_DistributionConstraints> = {
  encode(message: Metadata_DistributionConstraints, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tlp !== undefined) {
      writer.uint32(8).int32(message.tlp);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Metadata_DistributionConstraints {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMetadata_DistributionConstraints();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.tlp = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Metadata_DistributionConstraints {
    return { tlp: isSet(object.tlp) ? tlpClassificationFromJSON(object.tlp) : undefined };
  },

  toJSON(message: Metadata_DistributionConstraints): unknown {
    const obj: any = {};
    if (message.tlp !== undefined) {
      obj.tlp = tlpClassificationToJSON(message.tlp);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Metadata_DistributionConstraints>, I>>(
    base?: I,
  ): Metadata_DistributionConstraints {
    return Metadata_DistributionConstraints.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Metadata_DistributionConstraints>, I>>(
    object: I,
  ): Metadata_DistributionConstraints {
    const message = createBaseMetadata_DistributionConstraints();
    message.tlp = object.tlp ?? undefined;
    return message;
  },
};
...
export const Service: MessageFns<Service> = {
  encode(message: Service, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.patentAssertions) {
      PatentAssertion.encode(v!, writer.uint32(146).fork()).join();
    }
    return writer;
  },
...
export const Definition: MessageFns<Definition> = {
  encode(message: Definition, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.patents) {
      PatentOrFamily.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.patents.push(PatentOrFamily.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Definition {
    return {
      standards: globalThis.Array.isArray(object?.standards)
        ...
        : [],
      patents: globalThis.Array.isArray(object?.patents)
        ? object.patents.map((e: any) => PatentOrFamily.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: Definition): unknown {
    ...
    if (message.patents?.length) {
      obj.patents = message.patents.map((e) => PatentOrFamily.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Definition>, I>>(object: I): Definition {
    ...
    message.patents = object.patents?.map((e) => PatentOrFamily.fromPartial(e)) || [];
    return message;
  },
};
...
function createBaseCryptoProperties_AlgorithmProperties(): CryptoProperties_AlgorithmProperties {
  return {
    primitive: undefined,
    algorithmFamily: undefined,
    parameterSetIdentifier: undefined,
    curve: undefined,
    ellipticCurve: undefined,
...
export const CryptoProperties_AlgorithmProperties: MessageFns<CryptoProperties_AlgorithmProperties> = {
  encode(message: CryptoProperties_AlgorithmProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.algorithmFamily !== undefined) {
      writer.uint32(98).string(message.algorithmFamily);
    }
    ...
    if (message.ellipticCurve !== undefined) {
      writer.uint32(106).string(message.ellipticCurve);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          message.algorithmFamily = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
        ...
        case 13: {
          ...
          message.ellipticCurve = reader.string();
          continue;
        }
        case 4: {
          if (tag !== 32) {
  ...
  fromJSON(object: any): CryptoProperties_AlgorithmProperties {
    return {
      primitive: isSet(object.primitive)
        ...
        : undefined,
      algorithmFamily: isSet(object.algorithmFamily) ? globalThis.String(object.algorithmFamily) : undefined,
      ...
      ellipticCurve: isSet(object.ellipticCurve) ? globalThis.String(object.ellipticCurve) : undefined,
  ...
  toJSON(message: CryptoProperties_AlgorithmProperties): unknown {
    ...
    if (message.algorithmFamily !== undefined) {
      obj.algorithmFamily = message.algorithmFamily;
    }
    if (message.parameterSetIdentifier !== undefined) {
    ...
    if (message.ellipticCurve !== undefined) {
      obj.ellipticCurve = message.ellipticCurve;
    }
    if (message.executionEnvironment !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_AlgorithmProperties>, I>>(
    ...
    message.algorithmFamily = object.algorithmFamily ?? undefined;
    message.parameterSetIdentifier = object.parameterSetIdentifier ?? undefined;
    message.curve = object.curve ?? undefined;
    message.ellipticCurve = object.ellipticCurve ?? undefined;
...
function createBaseCryptoProperties_CertificateState(): CryptoProperties_CertificateState {
  return { reason: undefined, predefinedState: undefined, name: undefined, description: undefined };
}

export const CryptoProperties_CertificateState: MessageFns<CryptoProperties_CertificateState> = {
  encode(message: CryptoProperties_CertificateState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.reason !== undefined) {
      writer.uint32(10).string(message.reason);
    }
    if (message.predefinedState !== undefined) {
      writer.uint32(16).int32(message.predefinedState);
    }
    if (message.name !== undefined) {
      writer.uint32(26).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CryptoProperties_CertificateState {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_CertificateState();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.predefinedState = reader.int32() as any;
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): CryptoProperties_CertificateState {
    return {
      reason: isSet(object.reason) ? globalThis.String(object.reason) : undefined,
      predefinedState: isSet(object.predefinedState)
        ? cryptoProperties_CertificateState_PredefinedStateFromJSON(object.predefinedState)
        : undefined,
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
      description: isSet(object.description) ? globalThis.String(object.description) : undefined,
    };
  ...
  toJSON(message: CryptoProperties_CertificateState): unknown {
    const obj: any = {};
    if (message.reason !== undefined) {
      obj.reason = message.reason;
    }
    if (message.predefinedState !== undefined) {
      obj.predefinedState = cryptoProperties_CertificateState_PredefinedStateToJSON(message.predefinedState);
    }
    if (message.name !== undefined) {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_CertificateState>, I>>(
    base?: I,
  ): CryptoProperties_CertificateState {
    return CryptoProperties_CertificateState.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_CertificateState>, I>>(
    object: I,
  ): CryptoProperties_CertificateState {
    const message = createBaseCryptoProperties_CertificateState();
    message.reason = object.reason ?? undefined;
    message.predefinedState = object.predefinedState ?? undefined;
    message.name = object.name ?? undefined;
    message.description = object.description ?? undefined;
    return message;
  },
...
function createBaseCryptoProperties_CertificateProperties(): CryptoProperties_CertificateProperties {
  return {
    ...
    certificateFileExtension: undefined,
    ...
    certificateExtensions: undefined,
    relatedCryptographicAssets: undefined,
  };
}
...
export const CryptoProperties_CertificateProperties: MessageFns<CryptoProperties_CertificateProperties> = {
  encode(message: CryptoProperties_CertificateProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.certificateFileExtension !== undefined) {
      writer.uint32(82).string(message.certificateFileExtension);
    }
    if (message.fingerprint !== undefined) {
      Hash.encode(message.fingerprint, writer.uint32(90).fork()).join();
    }
    for (const v of message.certificateState) {
      CryptoProperties_CertificateState.encode(v!, writer.uint32(98).fork()).join();
    }
    if (message.creationDate !== undefined) {
      Timestamp.encode(toTimestamp(message.creationDate), writer.uint32(106).fork()).join();
    }
    if (message.activationDate !== undefined) {
      Timestamp.encode(toTimestamp(message.activationDate), writer.uint32(114).fork()).join();
    }
    if (message.deactivationDate !== undefined) {
      Timestamp.encode(toTimestamp(message.deactivationDate), writer.uint32(122).fork()).join();
    }
    if (message.revocationDate !== undefined) {
      Timestamp.encode(toTimestamp(message.revocationDate), writer.uint32(130).fork()).join();
    }
    if (message.destructionDate !== undefined) {
      Timestamp.encode(toTimestamp(message.destructionDate), writer.uint32(138).fork()).join();
    }
    if (message.certificateExtensions !== undefined) {
      CryptoProperties_CertificateExtensions.encode(message.certificateExtensions, writer.uint32(146).fork()).join();
    }
    if (message.relatedCryptographicAssets !== undefined) {
      CryptoProperties_RelatedCryptographicAssets.encode(message.relatedCryptographicAssets, writer.uint32(154).fork())
        .join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.certificateFileExtension = reader.string();
          continue;
        }
        case 11: {
          if (tag !== 90) {
          ...
          message.fingerprint = Hash.decode(reader, reader.uint32());
          continue;
        }
        case 12: {
          if (tag !== 98) {
          ...
          message.certificateState.push(CryptoProperties_CertificateState.decode(reader, reader.uint32()));
          continue;
        }
        case 13: {
          if (tag !== 106) {
        ...
        case 16: {
          ...
          message.revocationDate = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        }
        case 17: {
          if (tag !== 138) {
          ...
          message.destructionDate = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        }
        case 18: {
          if (tag !== 146) {
          ...
          message.certificateExtensions = CryptoProperties_CertificateExtensions.decode(reader, reader.uint32());
          continue;
        }
        case 19: {
          if (tag !== 154) {
          ...
          message.relatedCryptographicAssets = CryptoProperties_RelatedCryptographicAssets.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): CryptoProperties_CertificateProperties {
    return {
      ...
      certificateExtension: isSet(object.certificateExtension)
        ...
        : undefined,
      certificateFileExtension: isSet(object.certificateFileExtension)
        ? globalThis.String(object.certificateFileExtension)
        : undefined,
      fingerprint: isSet(object.fingerprint) ? Hash.fromJSON(object.fingerprint) : undefined,
      certificateState: globalThis.Array.isArray(object?.certificateState)
        ? object.certificateState.map((e: any) => CryptoProperties_CertificateState.fromJSON(e))
        : [],
      ...
      revocationDate: isSet(object.revocationDate) ? fromJsonTimestamp(object.revocationDate) : undefined,
      destructionDate: isSet(object.destructionDate) ? fromJsonTimestamp(object.destructionDate) : undefined,
      certificateExtensions: isSet(object.certificateExtensions)
        ? CryptoProperties_CertificateExtensions.fromJSON(object.certificateExtensions)
        : undefined,
      relatedCryptographicAssets: isSet(object.relatedCryptographicAssets)
        ? CryptoProperties_RelatedCryptographicAssets.fromJSON(object.relatedCryptographicAssets)
        : undefined,
    };
  },
  ...
  toJSON(message: CryptoProperties_CertificateProperties): unknown {
    ...
    if (message.certificateFileExtension !== undefined) {
      obj.certificateFileExtension = message.certificateFileExtension;
    }
    if (message.fingerprint !== undefined) {
      obj.fingerprint = Hash.toJSON(message.fingerprint);
    }
    if (message.certificateState?.length) {
      obj.certificateState = message.certificateState.map((e) => CryptoProperties_CertificateState.toJSON(e));
    }
    if (message.creationDate !== undefined) {
    ...
    if (message.revocationDate !== undefined) {
      obj.revocationDate = message.revocationDate.toISOString();
    }
    if (message.destructionDate !== undefined) {
      obj.destructionDate = message.destructionDate.toISOString();
    }
    if (message.certificateExtensions !== undefined) {
      obj.certificateExtensions = CryptoProperties_CertificateExtensions.toJSON(message.certificateExtensions);
    }
    if (message.relatedCryptographicAssets !== undefined) {
      obj.relatedCryptographicAssets = CryptoProperties_RelatedCryptographicAssets.toJSON(
  ...
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_CertificateProperties>, I>>(
    ...
    message.certificateFileExtension = object.certificateFileExtension ?? undefined;
    message.fingerprint = (object.fingerprint !== undefined && object.fingerprint !== null)
      ? Hash.fromPartial(object.fingerprint)
      : undefined;
    message.certificateState = object.certificateState?.map((e) => CryptoProperties_CertificateState.fromPartial(e)) ||
      [];
    ...
    message.revocationDate = object.revocationDate ?? undefined;
    message.destructionDate = object.destructionDate ?? undefined;
    message.certificateExtensions =
      (object.certificateExtensions !== undefined && object.certificateExtensions !== null)
        ? CryptoProperties_CertificateExtensions.fromPartial(object.certificateExtensions)
        : undefined;
    message.relatedCryptographicAssets =
      (object.relatedCryptographicAssets !== undefined && object.relatedCryptographicAssets !== null)
        ? CryptoProperties_RelatedCryptographicAssets.fromPartial(object.relatedCryptographicAssets)
        : undefined;
    return message;
  },
};

function createBaseCryptoProperties_CertificateExtensions(): CryptoProperties_CertificateExtensions {
  return { extensions: [] };
}

export const CryptoProperties_CertificateExtensions: MessageFns<CryptoProperties_CertificateExtensions> = {
  encode(message: CryptoProperties_CertificateExtensions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.extensions) {
      CryptoProperties_CertificateExtensions_Extension.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CryptoProperties_CertificateExtensions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_CertificateExtensions();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.extensions.push(CryptoProperties_CertificateExtensions_Extension.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CryptoProperties_CertificateExtensions {
    return {
      extensions: globalThis.Array.isArray(object?.extensions)
        ? object.extensions.map((e: any) => CryptoProperties_CertificateExtensions_Extension.fromJSON(e))
        : [],
    };
  },

  toJSON(message: CryptoProperties_CertificateExtensions): unknown {
    const obj: any = {};
    if (message.extensions?.length) {
      obj.extensions = message.extensions.map((e) => CryptoProperties_CertificateExtensions_Extension.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions>, I>>(
    base?: I,
  ): CryptoProperties_CertificateExtensions {
    return CryptoProperties_CertificateExtensions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions>, I>>(
    object: I,
  ): CryptoProperties_CertificateExtensions {
    const message = createBaseCryptoProperties_CertificateExtensions();
    message.extensions =
      object.extensions?.map((e) => CryptoProperties_CertificateExtensions_Extension.fromPartial(e)) || [];
    return message;
  },
};

function createBaseCryptoProperties_CertificateExtensions_Extension(): CryptoProperties_CertificateExtensions_Extension {
  return { commonExtension: undefined, customExtension: undefined };
}

export const CryptoProperties_CertificateExtensions_Extension: MessageFns<
  CryptoProperties_CertificateExtensions_Extension
> = {
  encode(
    message: CryptoProperties_CertificateExtensions_Extension,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.commonExtension !== undefined) {
      CryptoProperties_CertificateExtensions_CommonExtension.encode(message.commonExtension, writer.uint32(10).fork())
        .join();
    }
    if (message.customExtension !== undefined) {
      CryptoProperties_CertificateExtensions_CustomExtension.encode(message.customExtension, writer.uint32(18).fork())
        .join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CryptoProperties_CertificateExtensions_Extension {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_CertificateExtensions_Extension();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.commonExtension = CryptoProperties_CertificateExtensions_CommonExtension.decode(
            reader,
            reader.uint32(),
          );
          continue;
        ...
        case 2: {
          ...
          message.customExtension = CryptoProperties_CertificateExtensions_CustomExtension.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): CryptoProperties_CertificateExtensions_Extension {
    return {
      commonExtension: isSet(object.commonExtension)
        ? CryptoProperties_CertificateExtensions_CommonExtension.fromJSON(object.commonExtension)
        : undefined,
      customExtension: isSet(object.customExtension)
        ? CryptoProperties_CertificateExtensions_CustomExtension.fromJSON(object.customExtension)
        : undefined,
    };
  },

  toJSON(message: CryptoProperties_CertificateExtensions_Extension): unknown {
    const obj: any = {};
    if (message.commonExtension !== undefined) {
      obj.commonExtension = CryptoProperties_CertificateExtensions_CommonExtension.toJSON(message.commonExtension);
    }
    if (message.customExtension !== undefined) {
      obj.customExtension = CryptoProperties_CertificateExtensions_CustomExtension.toJSON(message.customExtension);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions_Extension>, I>>(
    base?: I,
  ): CryptoProperties_CertificateExtensions_Extension {
    return CryptoProperties_CertificateExtensions_Extension.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions_Extension>, I>>(
    object: I,
  ): CryptoProperties_CertificateExtensions_Extension {
    const message = createBaseCryptoProperties_CertificateExtensions_Extension();
    message.commonExtension = (object.commonExtension !== undefined && object.commonExtension !== null)
      ? CryptoProperties_CertificateExtensions_CommonExtension.fromPartial(object.commonExtension)
      : undefined;
    message.customExtension = (object.customExtension !== undefined && object.customExtension !== null)
      ? CryptoProperties_CertificateExtensions_CustomExtension.fromPartial(object.customExtension)
      : undefined;
    return message;
  },
};

function createBaseCryptoProperties_CertificateExtensions_CommonExtension(): CryptoProperties_CertificateExtensions_CommonExtension {
  return { name: 0, value: "" };
}

export const CryptoProperties_CertificateExtensions_CommonExtension: MessageFns<
  CryptoProperties_CertificateExtensions_CommonExtension
> = {
  encode(
    message: CryptoProperties_CertificateExtensions_CommonExtension,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.name !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CryptoProperties_CertificateExtensions_CommonExtension {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_CertificateExtensions_CommonExtension();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CryptoProperties_CertificateExtensions_CommonExtension {
    return {
      name: isSet(object.name) ? cryptoProperties_CertificateExtensions_CommonExtensionNameFromJSON(object.name) : 0,
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  },

  toJSON(message: CryptoProperties_CertificateExtensions_CommonExtension): unknown {
    const obj: any = {};
    if (message.name !== 0) {
      obj.name = cryptoProperties_CertificateExtensions_CommonExtensionNameToJSON(message.name);
    }
    if (message.value !== "") {
      obj.value = message.value;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions_CommonExtension>, I>>(
    base?: I,
  ): CryptoProperties_CertificateExtensions_CommonExtension {
    return CryptoProperties_CertificateExtensions_CommonExtension.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions_CommonExtension>, I>>(
    object: I,
  ): CryptoProperties_CertificateExtensions_CommonExtension {
    const message = createBaseCryptoProperties_CertificateExtensions_CommonExtension();
...
function createBaseCryptoProperties_CertificateExtensions_CustomExtension(): CryptoProperties_CertificateExtensions_CustomExtension {
  return { name: "", value: undefined };
}

export const CryptoProperties_CertificateExtensions_CustomExtension: MessageFns<
  CryptoProperties_CertificateExtensions_CustomExtension
> = {
  encode(
    message: CryptoProperties_CertificateExtensions_CustomExtension,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CryptoProperties_CertificateExtensions_CustomExtension {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_CertificateExtensions_CustomExtension();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CryptoProperties_CertificateExtensions_CustomExtension {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : undefined,
    };
  ...
  toJSON(message: CryptoProperties_CertificateExtensions_CustomExtension): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions_CustomExtension>, I>>(
    base?: I,
  ): CryptoProperties_CertificateExtensions_CustomExtension {
    return CryptoProperties_CertificateExtensions_CustomExtension.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_CertificateExtensions_CustomExtension>, I>>(
    object: I,
  ): CryptoProperties_CertificateExtensions_CustomExtension {
    const message = createBaseCryptoProperties_CertificateExtensions_CustomExtension();
    message.name = object.name ?? "";
...
function createBaseCryptoProperties_RelatedCryptographicAssets(): CryptoProperties_RelatedCryptographicAssets {
  return { assets: [] };
}

export const CryptoProperties_RelatedCryptographicAssets: MessageFns<CryptoProperties_RelatedCryptographicAssets> = {
  encode(
    message: CryptoProperties_RelatedCryptographicAssets,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    for (const v of message.assets) {
      CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CryptoProperties_RelatedCryptographicAssets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_RelatedCryptographicAssets();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.assets.push(
            CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset.decode(reader, reader.uint32()),
          );
          continue;
        }
      }
  ...
  fromJSON(object: any): CryptoProperties_RelatedCryptographicAssets {
    return {
      assets: globalThis.Array.isArray(object?.assets)
        ? object.assets.map((e: any) =>
          CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset.fromJSON(e)
        )
        : [],
    };
  },

  toJSON(message: CryptoProperties_RelatedCryptographicAssets): unknown {
    const obj: any = {};
    if (message.assets?.length) {
      obj.assets = message.assets.map((e) =>
        CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset.toJSON(e)
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<CryptoProperties_RelatedCryptographicAssets>, I>>(
    base?: I,
  ): CryptoProperties_RelatedCryptographicAssets {
    return CryptoProperties_RelatedCryptographicAssets.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_RelatedCryptographicAssets>, I>>(
    object: I,
  ): CryptoProperties_RelatedCryptographicAssets {
    const message = createBaseCryptoProperties_RelatedCryptographicAssets();
    message.assets =
      object.assets?.map((e) => CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset.fromPartial(e)) ||
      [];
    return message;
  },
};

function createBaseCryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset(): CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset {
  return { type: "", ref: "" };
}

export const CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset: MessageFns<
  CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset
> = {
  encode(
    message: CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.type !== "") {
      writer.uint32(10).string(message.type);
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset {
    return {
      type: isSet(object.type) ? globalThis.String(object.type) : "",
      ref: isSet(object.ref) ? globalThis.String(object.ref) : "",
    };
  ...
  toJSON(message: CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset): unknown {
    const obj: any = {};
    if (message.type !== "") {
      obj.type = message.type;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset>, I>>(
    base?: I,
  ): CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset {
    return CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset>, I>>(
    object: I,
  ): CryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset {
    const message = createBaseCryptoProperties_RelatedCryptographicAssets_RelatedCryptographicAsset();
    message.type = object.type ?? "";
...
> = {
  encode(
    ...
    if (message.fingerprint !== undefined) {
      Hash.encode(message.fingerprint, writer.uint32(106).fork()).join();
    }
    if (message.relatedCryptographicAssets !== undefined) {
      CryptoProperties_RelatedCryptographicAssets.encode(message.relatedCryptographicAssets, writer.uint32(114).fork())
        .join();
    }
    return writer;
  },
...
function createBaseCryptoProperties_ProtocolProperties(): CryptoProperties_ProtocolProperties {
  return {
    ...
    version: undefined,
    cipherSuites: [],
    ikev2TransformTypes: undefined,
    ikev2TransformTypesDetailed: undefined,
    cryptoRef: [],
    relatedCryptographicAssets: undefined,
  };
}
...
export const CryptoProperties_ProtocolProperties: MessageFns<CryptoProperties_ProtocolProperties> = {
  encode(message: CryptoProperties_ProtocolProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.ikev2TransformTypesDetailed !== undefined) {
      CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed.encode(
    ...
    if (message.relatedCryptographicAssets !== undefined) {
      CryptoProperties_RelatedCryptographicAssets.encode(message.relatedCryptographicAssets, writer.uint32(50).fork())
        .join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.ikev2TransformTypesDetailed = CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties {
    return {
      ...
      ikev2TransformTypes: isSet(object.ikev2TransformTypes)
        ...
        : undefined,
      ikev2TransformTypesDetailed: isSet(object.ikev2TransformTypesDetailed)
        ? CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed.fromJSON(object.ikev2TransformTypesDetailed)
        : undefined,
  ...
  toJSON(message: CryptoProperties_ProtocolProperties): unknown {
    ...
    if (message.ikev2TransformTypesDetailed !== undefined) {
      obj.ikev2TransformTypesDetailed = CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed.toJSON(
        message.ikev2TransformTypesDetailed,
      );
    }
  ...
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties>, I>>(
    ...
    message.ikev2TransformTypes = (object.ikev2TransformTypes !== undefined && object.ikev2TransformTypes !== null)
      ...
      : undefined;
    message.ikev2TransformTypesDetailed =
      (object.ikev2TransformTypesDetailed !== undefined && object.ikev2TransformTypesDetailed !== null)
        ? CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed.fromPartial(
          object.ikev2TransformTypesDetailed,
        )
        : undefined;
...
function createBaseCryptoProperties_ProtocolProperties_CryptoProtocolCipherSuite(): CryptoProperties_ProtocolProperties_CryptoProtocolCipherSuite {
  return { name: undefined, algorithms: [], identifiers: [], tlsGroups: [], tlsSignatureSchemes: [] };
}
...
> = {
  encode(
    ...
    for (const v of message.tlsGroups) {
      writer.uint32(34).string(v!);
    }
    for (const v of message.tlsSignatureSchemes) {
      writer.uint32(42).string(v!);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.tlsGroups.push(reader.string());
          continue;
        }
        case 5: {
          if (tag !== 42) {
          ...
          message.tlsSignatureSchemes.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties_CryptoProtocolCipherSuite {
    return {
      ...
      identifiers: globalThis.Array.isArray(object?.identifiers)
        ...
        : [],
      tlsGroups: globalThis.Array.isArray(object?.tlsGroups)
        ? object.tlsGroups.map((e: any) => globalThis.String(e))
        : [],
      tlsSignatureSchemes: globalThis.Array.isArray(object?.tlsSignatureSchemes)
        ? object.tlsSignatureSchemes.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: CryptoProperties_ProtocolProperties_CryptoProtocolCipherSuite): unknown {
    ...
    if (message.tlsGroups?.length) {
      obj.tlsGroups = message.tlsGroups;
    }
    if (message.tlsSignatureSchemes?.length) {
      obj.tlsSignatureSchemes = message.tlsSignatureSchemes;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_CryptoProtocolCipherSuite>, I>>(
    ...
    message.tlsGroups = object.tlsGroups?.map((e) => e) || [];
    message.tlsSignatureSchemes = object.tlsSignatureSchemes?.map((e) => e) || [];
    return message;
  },
};
...
function createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed(): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed {
  return { encr: [], prf: [], integ: [], ke: [], esn: undefined, auth: [] };
}

export const CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed: MessageFns<
  CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed
> = {
  encode(
    message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    for (const v of message.encr) {
      CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.prf) {
      CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.integ) {
      CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.ke) {
      CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.esn !== undefined) {
      writer.uint32(40).bool(message.esn);
    }
    for (const v of message.auth) {
      CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.encr.push(
            CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr.decode(reader, reader.uint32()),
          );
          continue;
        }
        case 2: {
          ...
          message.prf.push(
            CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf.decode(reader, reader.uint32()),
          );
          continue;
        }
        case 3: {
          ...
          message.integ.push(
            CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ.decode(reader, reader.uint32()),
          );
          continue;
        }
        case 4: {
          ...
          message.ke.push(
            CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke.decode(reader, reader.uint32()),
          );
          continue;
        }
        case 5: {
        ...
        case 6: {
          ...
          message.auth.push(
            CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth.decode(reader, reader.uint32()),
          );
          continue;
        }
      }
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed {
    return {
      encr: globalThis.Array.isArray(object?.encr)
        ? object.encr.map((e: any) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr.fromJSON(e))
        : [],
      prf: globalThis.Array.isArray(object?.prf)
        ? object.prf.map((e: any) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf.fromJSON(e))
        : [],
      integ: globalThis.Array.isArray(object?.integ)
        ? object.integ.map((e: any) =>
          CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ.fromJSON(e)
        )
        : [],
      ke: globalThis.Array.isArray(object?.ke)
        ? object.ke.map((e: any) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke.fromJSON(e))
        : [],
      esn: isSet(object.esn) ? globalThis.Boolean(object.esn) : undefined,
      auth: globalThis.Array.isArray(object?.auth)
        ? object.auth.map((e: any) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth.fromJSON(e))
        : [],
    };
  },

  toJSON(message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed): unknown {
    const obj: any = {};
    if (message.encr?.length) {
      obj.encr = message.encr.map((e) =>
        CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr.toJSON(e)
      );
    }
    if (message.prf?.length) {
      obj.prf = message.prf.map((e) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf.toJSON(e));
    }
    if (message.integ?.length) {
      obj.integ = message.integ.map((e) =>
        CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ.toJSON(e)
      );
    }
    if (message.ke?.length) {
      obj.ke = message.ke.map((e) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke.toJSON(e));
    }
    if (message.esn !== undefined) {
      obj.esn = message.esn;
    }
    if (message.auth?.length) {
      obj.auth = message.auth.map((e) =>
        CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth.toJSON(e)
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed>, I>>(
    base?: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed {
    return CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed>, I>>(
    object: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed {
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed();
    message.encr =
      object.encr?.map((e) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr.fromPartial(e)) ||
      [];
    message.prf =
      object.prf?.map((e) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf.fromPartial(e)) || [];
    message.integ =
      object.integ?.map((e) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ.fromPartial(e)) ||
      [];
    message.ke =
      object.ke?.map((e) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke.fromPartial(e)) || [];
    message.esn = object.esn ?? undefined;
    message.auth =
      object.auth?.map((e) => CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth.fromPartial(e)) ||
      [];
    return message;
  },
};

function createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr(): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr {
  return { name: undefined, keyLength: undefined, algorithm: undefined };
}

export const CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr: MessageFns<
  CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr
> = {
  encode(
    message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.name !== undefined) {
      writer.uint32(10).string(message.name);
    }
    if (message.keyLength !== undefined) {
      writer.uint32(16).int32(message.keyLength);
    }
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.keyLength = reader.int32();
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
      keyLength: isSet(object.keyLength) ? globalThis.Number(object.keyLength) : undefined,
      algorithm: isSet(object.algorithm) ? globalThis.String(object.algorithm) : undefined,
    };
  },

  toJSON(message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr): unknown {
    const obj: any = {};
    if (message.name !== undefined) {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr>, I>>(
    base?: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr {
    return CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr>, I>>(
    object: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr {
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Encr();
    message.name = object.name ?? undefined;
    message.keyLength = object.keyLength ?? undefined;
    message.algorithm = object.algorithm ?? undefined;
    return message;
  },
};

function createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf(): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf {
  return { name: undefined, algorithm: undefined };
}

export const CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf: MessageFns<
  CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf
> = {
  encode(
    message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.name !== undefined) {
      writer.uint32(10).string(message.name);
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
      algorithm: isSet(object.algorithm) ? globalThis.String(object.algorithm) : undefined,
    };
  ...
  toJSON(message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf): unknown {
    const obj: any = {};
    if (message.name !== undefined) {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf>, I>>(
    base?: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf {
    return CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf>, I>>(
    object: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf {
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Prf();
    message.name = object.name ?? undefined;
...
function createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ(): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ {
  return { name: undefined, algorithm: undefined };
}

export const CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ: MessageFns<
  CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ
> = {
  encode(
    message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.name !== undefined) {
      writer.uint32(10).string(message.name);
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
      algorithm: isSet(object.algorithm) ? globalThis.String(object.algorithm) : undefined,
    };
  ...
  toJSON(message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ): unknown {
    const obj: any = {};
    if (message.name !== undefined) {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ>, I>>(
    base?: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ {
    return CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ>, I>>(
    object: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ {
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Integ();
    message.name = object.name ?? undefined;
...
function createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke(): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke {
  return { group: undefined, algorithm: undefined };
}

export const CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke: MessageFns<
  CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke
> = {
  encode(
    message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.group !== undefined) {
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke {
    return {
      group: isSet(object.group) ? globalThis.Number(object.group) : undefined,
      algorithm: isSet(object.algorithm) ? globalThis.String(object.algorithm) : undefined,
    };
  },

  toJSON(message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke): unknown {
    const obj: any = {};
    if (message.group !== undefined) {
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke>, I>>(
    base?: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke {
    return CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke>, I>>(
    object: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke {
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Ke();
    message.group = object.group ?? undefined;
...
function createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth(): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth {
  return { name: undefined, algorithm: undefined };
}

export const CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth: MessageFns<
  CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth
> = {
  encode(
    message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.name !== undefined) {
      writer.uint32(10).string(message.name);
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
      algorithm: isSet(object.algorithm) ? globalThis.String(object.algorithm) : undefined,
    };
  ...
  toJSON(message: CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth): unknown {
    const obj: any = {};
    if (message.name !== undefined) {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth>, I>>(
    base?: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth {
    return CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth>, I>>(
    object: I,
  ): CryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth {
    const message = createBaseCryptoProperties_ProtocolProperties_Ikev2TransformTypesDetailed_Auth();
    message.name = object.name ?? undefined;
...
function createBasePatentOrFamily(): PatentOrFamily {
  return { patent: undefined, patentFamily: undefined };
}

export const PatentOrFamily: MessageFns<PatentOrFamily> = {
  encode(message: PatentOrFamily, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.patent !== undefined) {
      Patent.encode(message.patent, writer.uint32(10).fork()).join();
    }
    if (message.patentFamily !== undefined) {
      PatentFamily.encode(message.patentFamily, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PatentOrFamily {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePatentOrFamily();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.patent = Patent.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.patentFamily = PatentFamily.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PatentOrFamily {
    return {
      patent: isSet(object.patent) ? Patent.fromJSON(object.patent) : undefined,
      patentFamily: isSet(object.patentFamily) ? PatentFamily.fromJSON(object.patentFamily) : undefined,
    };
  },

  toJSON(message: PatentOrFamily): unknown {
    const obj: any = {};
    if (message.patent !== undefined) {
      obj.patent = Patent.toJSON(message.patent);
    }
    if (message.patentFamily !== undefined) {
      obj.patentFamily = PatentFamily.toJSON(message.patentFamily);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<PatentOrFamily>, I>>(base?: I): PatentOrFamily {
    return PatentOrFamily.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PatentOrFamily>, I>>(object: I): PatentOrFamily {
    const message = createBasePatentOrFamily();
    message.patent = (object.patent !== undefined && object.patent !== null)
      ? Patent.fromPartial(object.patent)
      : undefined;
    message.patentFamily = (object.patentFamily !== undefined && object.patentFamily !== null)
      ? PatentFamily.fromPartial(object.patentFamily)
      : undefined;
    return message;
  },
};

function createBasePriorityApplication(): PriorityApplication {
  return { applicationNumber: "", jurisdiction: "", filingDate: undefined };
}

export const PriorityApplication: MessageFns<PriorityApplication> = {
  encode(message: PriorityApplication, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.applicationNumber !== "") {
      writer.uint32(10).string(message.applicationNumber);
    }
    if (message.jurisdiction !== "") {
      writer.uint32(18).string(message.jurisdiction);
    }
    if (message.filingDate !== undefined) {
      Timestamp.encode(toTimestamp(message.filingDate), writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PriorityApplication {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePriorityApplication();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.applicationNumber = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
        ...
        case 3: {
          ...
          message.filingDate = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PriorityApplication {
    return {
      applicationNumber: isSet(object.applicationNumber) ? globalThis.String(object.applicationNumber) : "",
      jurisdiction: isSet(object.jurisdiction) ? globalThis.String(object.jurisdiction) : "",
      filingDate: isSet(object.filingDate) ? fromJsonTimestamp(object.filingDate) : undefined,
    };
  },

  toJSON(message: PriorityApplication): unknown {
    const obj: any = {};
    if (message.applicationNumber !== "") {
      obj.applicationNumber = message.applicationNumber;
    }
    if (message.jurisdiction !== "") {
      obj.jurisdiction = message.jurisdiction;
    }
    if (message.filingDate !== undefined) {
      obj.filingDate = message.filingDate.toISOString();
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<PriorityApplication>, I>>(base?: I): PriorityApplication {
    return PriorityApplication.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PriorityApplication>, I>>(object: I): PriorityApplication {
    const message = createBasePriorityApplication();
    message.applicationNumber = object.applicationNumber ?? "";
...
function createBasePatent(): Patent {
  return {
    bomRef: undefined,
    patentNumber: "",
    ...
    grantDate: undefined,
    patentExpirationDate: undefined,
    patentLegalStatus: 0,
    patentAssignee: [],
    externalReferences: [],
  };
...
export const Patent: MessageFns<Patent> = {
  encode(message: Patent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bomRef !== undefined) {
      writer.uint32(10).string(message.bomRef);
    }
    if (message.patentNumber !== "") {
      writer.uint32(18).string(message.patentNumber);
    }
    if (message.applicationNumber !== undefined) {
      writer.uint32(26).string(message.applicationNumber);
    }
    if (message.jurisdiction !== "") {
      writer.uint32(34).string(message.jurisdiction);
    }
    if (message.priorityApplication !== undefined) {
      PriorityApplication.encode(message.priorityApplication, writer.uint32(42).fork()).join();
    }
    if (message.publicationNumber !== undefined) {
      writer.uint32(50).string(message.publicationNumber);
    }
    if (message.title !== undefined) {
      writer.uint32(58).string(message.title);
    }
    if (message.abstract !== undefined) {
      writer.uint32(66).string(message.abstract);
    }
    if (message.filingDate !== undefined) {
      Timestamp.encode(toTimestamp(message.filingDate), writer.uint32(74).fork()).join();
    }
    if (message.grantDate !== undefined) {
      Timestamp.encode(toTimestamp(message.grantDate), writer.uint32(82).fork()).join();
    }
    if (message.patentExpirationDate !== undefined) {
      Timestamp.encode(toTimestamp(message.patentExpirationDate), writer.uint32(90).fork()).join();
    }
    if (message.patentLegalStatus !== 0) {
      writer.uint32(96).int32(message.patentLegalStatus);
    }
    for (const v of message.patentAssignee) {
      OrganizationalEntityOrContact.encode(v!, writer.uint32(106).fork()).join();
    }
    for (const v of message.externalReferences) {
      ExternalReference.encode(v!, writer.uint32(114).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Patent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePatent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 5: {
          ...
          message.priorityApplication = PriorityApplication.decode(reader, reader.uint32());
          continue;
        }
        case 6: {
          if (tag !== 50) {
          ...
          message.publicationNumber = reader.string();
          continue;
        }
        case 7: {
          if (tag !== 58) {
        ...
        case 10: {
          ...
          message.grantDate = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        }
        case 11: {
          if (tag !== 90) {
          ...
          message.patentExpirationDate = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        }
        case 12: {
          if (tag !== 96) {
          ...
          message.patentLegalStatus = reader.int32() as any;
          continue;
        }
        case 13: {
          if (tag !== 106) {
          ...
          message.patentAssignee.push(OrganizationalEntityOrContact.decode(reader, reader.uint32()));
          continue;
        }
        case 14: {
          if (tag !== 114) {
  ...
  fromJSON(object: any): Patent {
    return {
      bomRef: isSet(object.bomRef) ? globalThis.String(object.bomRef) : undefined,
      patentNumber: isSet(object.patentNumber) ? globalThis.String(object.patentNumber) : "",
      applicationNumber: isSet(object.applicationNumber) ? globalThis.String(object.applicationNumber) : undefined,
      jurisdiction: isSet(object.jurisdiction) ? globalThis.String(object.jurisdiction) : "",
      priorityApplication: isSet(object.priorityApplication)
        ? PriorityApplication.fromJSON(object.priorityApplication)
        : undefined,
      publicationNumber: isSet(object.publicationNumber) ? globalThis.String(object.publicationNumber) : undefined,
      title: isSet(object.title) ? globalThis.String(object.title) : undefined,
      abstract: isSet(object.abstract) ? globalThis.String(object.abstract) : undefined,
      filingDate: isSet(object.filingDate) ? fromJsonTimestamp(object.filingDate) : undefined,
      grantDate: isSet(object.grantDate) ? fromJsonTimestamp(object.grantDate) : undefined,
      patentExpirationDate: isSet(object.patentExpirationDate)
        ? fromJsonTimestamp(object.patentExpirationDate)
        : undefined,
      patentLegalStatus: isSet(object.patentLegalStatus) ? patentLegalStatusFromJSON(object.patentLegalStatus) : 0,
      patentAssignee: globalThis.Array.isArray(object?.patentAssignee)
        ? object.patentAssignee.map((e: any) => OrganizationalEntityOrContact.fromJSON(e))
        : [],
      externalReferences: globalThis.Array.isArray(object?.externalReferences)
        ? object.externalReferences.map((e: any) => ExternalReference.fromJSON(e))
        : [],
  ...
  toJSON(message: Patent): unknown {
    const obj: any = {};
    if (message.bomRef !== undefined) {
      obj.bomRef = message.bomRef;
    }
    if (message.patentNumber !== "") {
      obj.patentNumber = message.patentNumber;
    }
    if (message.applicationNumber !== undefined) {
      obj.applicationNumber = message.applicationNumber;
    }
    ...
    if (message.priorityApplication !== undefined) {
      obj.priorityApplication = PriorityApplication.toJSON(message.priorityApplication);
    }
    if (message.publicationNumber !== undefined) {
      obj.publicationNumber = message.publicationNumber;
    }
    if (message.title !== undefined) {
      obj.title = message.title;
    }
    ...
    if (message.grantDate !== undefined) {
      obj.grantDate = message.grantDate.toISOString();
    }
    if (message.patentExpirationDate !== undefined) {
      obj.patentExpirationDate = message.patentExpirationDate.toISOString();
    }
    if (message.patentLegalStatus !== 0) {
      obj.patentLegalStatus = patentLegalStatusToJSON(message.patentLegalStatus);
    }
    if (message.patentAssignee?.length) {
      obj.patentAssignee = message.patentAssignee.map((e) => OrganizationalEntityOrContact.toJSON(e));
    }
    if (message.externalReferences?.length) {
      obj.externalReferences = message.externalReferences.map((e) => ExternalReference.toJSON(e));
    }
  ...
  create<I extends Exact<DeepPartial<Patent>, I>>(base?: I): Patent {
    return Patent.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Patent>, I>>(object: I): Patent {
    const message = createBasePatent();
    message.bomRef = object.bomRef ?? undefined;
    message.patentNumber = object.patentNumber ?? "";
    message.applicationNumber = object.applicationNumber ?? undefined;
    message.jurisdiction = object.jurisdiction ?? "";
    message.priorityApplication = (object.priorityApplication !== undefined && object.priorityApplication !== null)
      ? PriorityApplication.fromPartial(object.priorityApplication)
      : undefined;
    message.publicationNumber = object.publicationNumber ?? undefined;
    message.title = object.title ?? undefined;
    message.abstract = object.abstract ?? undefined;
    message.filingDate = object.filingDate ?? undefined;
    message.grantDate = object.grantDate ?? undefined;
    message.patentExpirationDate = object.patentExpirationDate ?? undefined;
    message.patentLegalStatus = object.patentLegalStatus ?? 0;
    message.patentAssignee = object.patentAssignee?.map((e) => OrganizationalEntityOrContact.fromPartial(e)) || [];
    message.externalReferences = object.externalReferences?.map((e) => ExternalReference.fromPartial(e)) || [];
    return message;
  },
};

function createBasePatentFamily(): PatentFamily {
  return { bomRef: undefined, familyId: "", priorityApplication: undefined, members: [], externalReferences: [] };
}

export const PatentFamily: MessageFns<PatentFamily> = {
  encode(message: PatentFamily, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bomRef !== undefined) {
      writer.uint32(10).string(message.bomRef);
    }
    if (message.familyId !== "") {
    ...
    if (message.priorityApplication !== undefined) {
      PriorityApplication.encode(message.priorityApplication, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PatentFamily {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePatentFamily();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): PatentFamily {
    return {
      bomRef: isSet(object.bomRef) ? globalThis.String(object.bomRef) : undefined,
  ...
  toJSON(message: PatentFamily): unknown {
    const obj: any = {};
    if (message.bomRef !== undefined) {
      obj.bomRef = message.bomRef;
    }
  ...
  create<I extends Exact<DeepPartial<PatentFamily>, I>>(base?: I): PatentFamily {
    return PatentFamily.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PatentFamily>, I>>(object: I): PatentFamily {
    const message = createBasePatentFamily();
    message.bomRef = object.bomRef ?? undefined;
...
function createBasePatentAssertion(): PatentAssertion {
  return { bomRef: undefined, assertionType: 0, patentRefs: [], asserter: undefined, notes: "" };
}

export const PatentAssertion: MessageFns<PatentAssertion> = {
  encode(message: PatentAssertion, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bomRef !== undefined) {
      writer.uint32(10).string(message.bomRef);
    }
    if (message.assertionType !== 0) {
      writer.uint32(16).int32(message.assertionType);
    }
    for (const v of message.patentRefs) {
      writer.uint32(26).string(v!);
    }
    if (message.asserter !== undefined) {
      Asserter.encode(message.asserter, writer.uint32(34).fork()).join();
    }
    if (message.notes !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PatentAssertion {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePatentAssertion();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.assertionType = reader.int32() as any;
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.patentRefs.push(reader.string());
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.asserter = Asserter.decode(reader, reader.uint32());
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): PatentAssertion {
    return {
      bomRef: isSet(object.bomRef) ? globalThis.String(object.bomRef) : undefined,
      assertionType: isSet(object.assertionType) ? patentAssertionTypeFromJSON(object.assertionType) : 0,
      patentRefs: globalThis.Array.isArray(object?.patentRefs)
        ? object.patentRefs.map((e: any) => globalThis.String(e))
        : [],
      asserter: isSet(object.asserter) ? Asserter.fromJSON(object.asserter) : undefined,
      notes: isSet(object.notes) ? globalThis.String(object.notes) : "",
    };
  },

  toJSON(message: PatentAssertion): unknown {
    const obj: any = {};
    if (message.bomRef !== undefined) {
      obj.bomRef = message.bomRef;
    }
    if (message.assertionType !== 0) {
      obj.assertionType = patentAssertionTypeToJSON(message.assertionType);
    }
    if (message.patentRefs?.length) {
      obj.patentRefs = message.patentRefs;
    }
    if (message.asserter !== undefined) {
      obj.asserter = Asserter.toJSON(message.asserter);
    }
    if (message.notes !== "") {
      obj.notes = message.notes;
    }
  ...
  create<I extends Exact<DeepPartial<PatentAssertion>, I>>(base?: I): PatentAssertion {
    return PatentAssertion.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PatentAssertion>, I>>(object: I): PatentAssertion {
    const message = createBasePatentAssertion();
    message.bomRef = object.bomRef ?? undefined;
    message.assertionType = object.assertionType ?? 0;
    message.patentRefs = object.patentRefs?.map((e) => e) || [];
    message.asserter = (object.asserter !== undefined && object.asserter !== null)
      ? Asserter.fromPartial(object.asserter)
      : undefined;
...
function createBaseAsserter(): Asserter {
  return { organization: undefined, individual: undefined, ref: undefined };
}

export const Asserter: MessageFns<Asserter> = {
  encode(message: Asserter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.organization !== undefined) {
      OrganizationalEntity.encode(message.organization, writer.uint32(10).fork()).join();
    }
    if (message.individual !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Asserter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAsserter();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  toJSON(message: Asserter): unknown {
    const obj: any = {};
    if (message.organization !== undefined) {
      obj.organization = OrganizationalEntity.toJSON(message.organization);
    }
  ...
  create<I extends Exact<DeepPartial<Asserter>, I>>(base?: I): Asserter {
    return Asserter.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Asserter>, I>>(object: I): Asserter {
    const message = createBaseAsserter();
    message.organization = (object.organization !== undefined && object.organization !== null)
      ? OrganizationalEntity.fromPartial(object.organization)
      : undefined;
...
export const Citation: MessageFns<Citation> = {
  encode(message: Citation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.pointers !== undefined) {
      Citation_Pointers.encode(message.pointers, writer.uint32(18).fork()).join();
    }
    if (message.expressions !== undefined) {
      Citation_Expressions.encode(message.expressions, writer.uint32(26).fork()).join();
    }
    if (message.timestamp !== undefined) {
      Timestamp.encode(toTimestamp(message.timestamp), writer.uint32(34).fork()).join();
    }
    if (message.attributedTo !== undefined) {
      writer.uint32(42).string(message.attributedTo);
    }
    if (message.process !== undefined) {
      writer.uint32(50).string(message.process);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.pointers = Citation_Pointers.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.expressions = Citation_Expressions.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
        ...
        case 5: {
          ...
          message.attributedTo = reader.string();
          continue;
        }
        case 6: {
          if (tag !== 50) {
  ...
  fromJSON(object: any): Citation {
    return {
      bomRef: isSet(object.bomRef) ? globalThis.String(object.bomRef) : undefined,
      pointers: isSet(object.pointers) ? Citation_Pointers.fromJSON(object.pointers) : undefined,
      expressions: isSet(object.expressions) ? Citation_Expressions.fromJSON(object.expressions) : undefined,
      timestamp: isSet(object.timestamp) ? fromJsonTimestamp(object.timestamp) : undefined,
      attributedTo: isSet(object.attributedTo) ? globalThis.String(object.attributedTo) : undefined,
  ...
  toJSON(message: Citation): unknown {
    ...
    if (message.pointers !== undefined) {
      obj.pointers = Citation_Pointers.toJSON(message.pointers);
    }
    if (message.expressions !== undefined) {
      obj.expressions = Citation_Expressions.toJSON(message.expressions);
    }
    if (message.timestamp !== undefined) {
      obj.timestamp = message.timestamp.toISOString();
    }
    if (message.attributedTo !== undefined) {
      obj.attributedTo = message.attributedTo;
    }
    if (message.process !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Citation>, I>>(object: I): Citation {
    ...
    message.pointers = (object.pointers !== undefined && object.pointers !== null)
      ? Citation_Pointers.fromPartial(object.pointers)
      : undefined;
    message.expressions = (object.expressions !== undefined && object.expressions !== null)
      ? Citation_Expressions.fromPartial(object.expressions)
      : undefined;
    message.timestamp = object.timestamp ?? undefined;
    message.attributedTo = object.attributedTo ?? undefined;
...
function createBaseCitation_Pointers(): Citation_Pointers {
  return { pointer: [] };
}

export const Citation_Pointers: MessageFns<Citation_Pointers> = {
  encode(message: Citation_Pointers, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.pointer) {
      writer.uint32(10).string(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Citation_Pointers {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCitation_Pointers();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.pointer.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Citation_Pointers {
    return {
      pointer: globalThis.Array.isArray(object?.pointer) ? object.pointer.map((e: any) => globalThis.String(e)) : [],
    };
  },

  toJSON(message: Citation_Pointers): unknown {
    const obj: any = {};
    if (message.pointer?.length) {
      obj.pointer = message.pointer;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Citation_Pointers>, I>>(base?: I): Citation_Pointers {
    return Citation_Pointers.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Citation_Pointers>, I>>(object: I): Citation_Pointers {
    const message = createBaseCitation_Pointers();
    message.pointer = object.pointer?.map((e) => e) || [];
    return message;
  },
};

function createBaseCitation_Expressions(): Citation_Expressions {
  return { expression: [] };
}

export const Citation_Expressions: MessageFns<Citation_Expressions> = {
  encode(message: Citation_Expressions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Citation_Expressions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCitation_Expressions();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.expression.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Citation_Expressions {
    return {
      expression: globalThis.Array.isArray(object?.expression)
        ? object.expression.map((e: any) => globalThis.String(e))
        : [],
    };
  },

  toJSON(message: Citation_Expressions): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<Citation_Expressions>, I>>(base?: I): Citation_Expressions {
    return Citation_Expressions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Citation_Expressions>, I>>(object: I): Citation_Expressions {
    const message = createBaseCitation_Expressions();
